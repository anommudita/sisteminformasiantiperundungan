...
<body>
    ...
    <div id="wrap" class="no-padding">
        <div id="main-wrapper">
            <header class="main-header">
                <div class="container">
                    <div class="logo"> <a href="#."> <img src="<?= base_url('assets/themes/sprint/') ?>images/logo.png" alt="Sprint Logo"></a> </div>
            ...
            <section class="home-slider">
                <div class="tp-banner-container">
                    <div class="tp-banner">
                        <ul>
                            <!-- Slider 1 -->
                            <li data-transition="fade" data-slotamount="5" data-masterspeed="700"> <img src="<?= base_url('assets/themes/sprint/') ?>images/slides/slide-1.jpg" alt="" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">

                                <!-- Layer -->
                                <div class="tp-caption sft font-montserrat text-uppercase tp-resizeme" data-x="center" data-hoffset="0" data-y="center" data-voffset="40" data-speed="700" data-start="1000" data-easing="easeOutBack" data-customin="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300" data-captionhidden="on" style="color: #fff; font-size: 48px; font-weight:bold; letter-spacing:2px;"> Sprint true Minimal theme </div>

                                <!-- Layer -->
                                <div class="tp-caption font-droid-serif sfb text-center text-uppercase tp-resizeme" data-x="center" data-hoffset="0" data-y="center" data-voffset="-30" data-speed="700" data-start="1500" data-easing="easeOutBack" data-customin="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300" data-captionhidden="on" style="color: #fff; font-size: 12px;  font-weight:bold; letter-spacing:4px;"> design / development / branding</div>
                            </li>

                            <!-- Slider 2 -->
                            <li data-transition="fade" data-slotamount="5" data-masterspeed="700"> <img src="<?= base_url('assets/themes/sprint/') ?>images/slides/slide-2.jpg" alt="" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">

                                <!-- Layer -->
                                <div class="tp-caption sft font-montserrat uppercase tp-resizeme" data-x="center" data-hoffset="0" data-y="center" data-voffset="-60" data-speed="700" data-start="1000" data-easing="easeOutBack" data-customin="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300" data-captionhidden="on" style="color: #fff; font-size: 45px; font-weight:bolder; letter-spacing:2px;"> WE ARE BLOSSOM </div>

                                <!-- Layer -->
                                <div class="tp-caption sft font-montserrat uppercase tp-resizeme" data-x="center" data-hoffset="0" data-y="center" data-voffset="0" data-speed="700" data-start="1300" data-easing="easeOutBack" data-customin="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300" data-captionhidden="on" style="color: #fff; font-size: 45px; font-weight:bolder; letter-spacing:2px;"> A CREATIVE DIGITAL AGENCY </div>

                                <!-- Layer -->
                                <div class="tp-caption sfb text-center tp-resizeme" data-x="center" data-hoffset="0" data-y="center" data-voffset="60" data-speed="700" data-start="1600" data-easing="easeOutBack" data-customin="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300" data-captionhidden="on" style="color: #fff; font-size: 14px;  font-weight:100; font-style: italic; letter-spacing:5px;"> Extraordinary art studio & creative minimal</div>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <section class="sectoion-100px about">
                <div class="container">
                    ...
                    <ul class="row">
                        <li class="col-sm-4"> <img class="img-responsive" src="<?= base_url('assets/themes/sprint/') ?>images/about-img-1.jpg" alt="">
                        ...
                        <li class="col-sm-4"> <img class="img-responsive" src="<?= base_url('assets/themes/sprint/') ?>images/about-img-2.jpg" alt="">
                            <h6 class="margin-top-20">our mission</h6>
                            <p>Can you tell me how to get how to get to SesaStreet. Now the world don't move to the beat of just one
                                um. What might be right for you the.</p>
                        </li>
                        <li class="col-sm-4"> <img class="img-responsive" src="<?= base_url('assets/themes/sprint/') ?>images/about-img-3.jpg" alt="">
                    ...
                    <ul class="row">
                        ...
                        <li class="col-md-4">
                            <div class="ser-in margin-bottom-30">
                                <div class="icon"> <img src="<?= base_url('assets/themes/sprint/') ?>images/icon-1.png" alt=""> </div>
                                <h5>Web designing</h5>
                                <hr>
                        ...
                        <li class="col-md-4">
                            <div class="ser-in margin-bottom-30">
                                <div class="icon"> <img src="<?= base_url('assets/themes/sprint/') ?>images/icon-2.png" alt=""> </div>
                        ...
                        <li class="col-md-4 margin-bottom-30">
                            <div class="ser-in">
                                <div class="icon"> <img src="<?= base_url('assets/themes/sprint/') ?>images/icon-3.png" alt=""> </div>
                                <h5>branding</h5>
                                <hr>
                                <p> These are the voyages of the Starship Enterpr movin' on up to the east side. We finally got a piece of thepie. </p>
                            </div>
                        ...
                        <li class="col-md-4">
                            <div class="ser-in margin-bottom-30">
                                <div class="icon"> <img src="<?= base_url('assets/themes/sprint/') ?>images/icon-4.png" alt=""> </div>
                                <h5>photography</h5>
                                <hr>
                                <p> These are the voyages of the Starship Enterpr movin' on up to the east side. We finally got a piece of thepie. </p>
                            </div>
                        ...
                        <li class="col-md-4">
                            <div class="ser-in margin-bottom-30">
                                <div class="icon"> <img src="<?= base_url('assets/themes/sprint/') ?>images/icon-5.png" alt=""> </div>
                        ...
                        <li class="col-md-4 margin-bottom-30">
                            <div class="ser-in">
                                <div class="icon"> <img src="<?= base_url('assets/themes/sprint/') ?>images/icon-6.png" alt=""> </div>
                                <h5>web analytics</h5>
                                <hr>
                                <p> These are the voyages of the Starship Enterpr movin' on up to the east side. We finally got a piece of thepie. </p>
                            </div>
                        ...
                        <div class="col-md-7 no-padding">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="unique">
                                    <div class="detail-in"> <img class="img-responsive" src="<?= base_url('assets/themes/sprint/') ?>images/why-choose-img-1.jpg" alt="">
            ...
            <section class="sectoion-100px no-padding-b portfolio padding-left-50 padding-right-50">
                ...
                <div class="container-fluid">
                    <ul class="port-folio-row no-margin-t folio-simple row col-4">
                        ...
                        <!-- Project 1 -->
                        <li class="item">
                            <article> <img src="<?= base_url('assets/themes/sprint/') ?>images/folio-img-1.jpg" alt="">
                                <!-- Hover Info -->
                        ...
                        <!-- Project 1 -->
                        <li class="item">
                            <article> <img src="<?= base_url('assets/themes/sprint/') ?>images/folio-img-2.jpg" alt="">
                                <!-- Hover Info -->
                                <div class="hover-port">
                                    <div class="position-center-center"> <a href="#."><i class="fa fa-link"></i></a>
                                        <h6>Awesome Projects</h6>
                        ...
                        <!-- Project 1 -->
                        <li class="item">
                            <article> <img src="<?= base_url('assets/themes/sprint/') ?>images/folio-img-3.jpg" alt="">
                                <!-- Hover Info -->
                                <div class="hover-port">
                                    <div class="position-center-center"> <a href="#."><i class="fa fa-link"></i></a>
                                        <h6>Awesome Projects</h6>
                        ...
                        <!-- Project 1 -->
                        <li class="item">
                            <article> <img src="<?= base_url('assets/themes/sprint/') ?>images/folio-img-4.jpg" alt="">
                                <!-- Hover Info -->
                                <div class="hover-port">
                                    <div class="position-center-center"> <a href="#."><i class="fa fa-link"></i></a>
                        ...
                        <li class="item int arch">
                            <article> <img src="<?= base_url('assets/themes/sprint/') ?>images/folio-img-5.jpg" alt="">
                                <!-- Hover Info -->
                                <div class="hover-port">
                                    <div class="position-center-center"> <a href="#."><i class="fa fa-link"></i></a>
                                        <h6>The mate was a mighty</h6>
                        ...
                        <!-- Project 1 -->
                        <li class="item">
                            <article> <img src="<?= base_url('assets/themes/sprint/') ?>images/folio-img-6.jpg" alt="">
                                <!-- Hover Info -->
                                <div class="hover-port">
                                    <div class="position-center-center"> <a href="#."><i class="fa fa-link"></i></a>
                                        <h6>The mate was a mighty</h6>
                        ...
                        <!-- Project 1 -->
                        <li class="item">
                            <article> <img src="<?= base_url('assets/themes/sprint/') ?>images/folio-img-7.jpg" alt="">
                                <!-- Hover Info -->
                                <div class="hover-port">
                                    <div class="position-center-center"> <a href="#."><i class="fa fa-link"></i></a>
                                        <h6>Awesome Projects</h6>
                        ...
                        <!-- Project 1 -->
                        <li class="item">
                            <article> <img src="<?= base_url('assets/themes/sprint/') ?>images/folio-img-8.jpg" alt="">
                                <!-- Hover Info -->
                                <div class="hover-port">
                                    <div class="position-center-center"> <a href="#."><i class="fa fa-link"></i></a>
                                        <h6>Awesome Projects</h6>
            ...
            <!--======= Parallax Section =========-->
            <section class="sectoion-100px parallax-bg" style="background: url(<?= base_url('assets/themes/sprint/') ?>images/bg/bg-1.jpg) center center fixed no-repeat;">
                <div class="container">
                    <h3>We do innovative things, so that we can
                        create awesome design</h3>
                    <a href="#." class="btn  margin-right-10">contact us</a> <a href="#." class="btn btn-1 margin-left-10">purchase now</a>
                </div>
            </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="blog-in">
                                ...
                                <!-- Post Image -->
                                <div class="blog-up-sec"> <img class="img-responsive" src="<?= base_url('assets/themes/sprint/') ?>images/blog-1.jpg" alt="">

                                    <!-- Post Date -->
                                    <div class="date-post"> 29 <span> AUG</span> <img src="<?= base_url('assets/themes/sprint/') ?>images/icon-date-post.png" alt=""> </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="blog-in">
                                ...
                                <!-- Post Image -->
                                <div class="blog-up-sec"> <img class="img-responsive" src="<?= base_url('assets/themes/sprint/') ?>images/blog-2.jpg" alt="">
            ...
            <section class="tastimonial tastimonial-bg padding-bottom-100">
                <div class="container">
                    ...
                    <div class="testi-slides">
                        ...
                        <!--======= SLIDE 1 =========-->
                        <div class="testi">
                            <div class="avatar"> <img src="<?= base_url('assets/themes/sprint/') ?>images/avatar-1.png"></div>
            ...
            <section class="sectoion-100px clients-logo  light-gray-bg">
                <div class="container">
                    ...
                    <ul class="row">
                        <li class="col-sm-4"> <img src="<?=base_url('assets/themes/sprint/')?>images/c-logo-1.png" alt=""> </li>
                        <li class="col-sm-4"> <img src="<?=base_url('assets/themes/sprint/')?>images/c-logo-2.png" alt=""> </li>
                        <li class="col-sm-4"> <img src="<?=base_url('assets/themes/sprint/')?>images/c-logo-3.png" alt=""> </li>
                        <li class="col-sm-4"> <img src="<?=base_url('assets/themes/sprint/')?>images/c-logo-4.png" alt=""> </li>
                        <li class="col-sm-4"> <img src="<?=base_url('assets/themes/sprint/')?>images/c-logo-5.png" alt=""> </li>
                        <li class="col-sm-4"> <img src="<?=base_url('assets/themes/sprint/')?>images/c-logo-6.png" alt=""> </li>
                    </ul>
                </div>
            </section>
    ...
    <script type="text/javascript" src="<?= base_url('assets/themes/sprint/') ?>rs-plugin/js/jquery.themepunch.tools.min.js"></script>
    <script type="text/javascript" src="<?= base_url('assets/themes/sprint/') ?>rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
    <script type='text/javascript' src='<?= base_url('assets/themes/sprint/') ?>http://maps.google.com/maps/api/js?sensor=false'></script>
    <!-- begin map script-->
