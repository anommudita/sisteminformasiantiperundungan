        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Tambah Sekolah</h6>
                </div>
...
<div class="container-fluid mt--6">
    <?= form_open_multipart('admin/tambah_sekolah') ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="kabupaten" class="form-control" id="kabupaten">
                                        ...
                                        <?php foreach ($kabupaten as $row) : ?>
                                            <option value="<?= $row['id']; ?>" data-kabupaten="<?= $row['id']; ?>"><?= $row['kabupaten']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-footer">
                    <a href="<?= base_url('admin/sekolah') ?>" class="btn btn-danger mr-4">Batal</a>
                    <input type="submit" value="Tambah Sekolah" class="btn btn-primary">
                </div>
            </div>
        </div>
    </div>
