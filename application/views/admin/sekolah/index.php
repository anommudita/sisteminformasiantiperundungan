        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Sekolah</h6>
                </div>
    ...
    <div class="row">
        <div class="col">
            ...
            <?php if ($this->session->flashdata('flash_failed')) : ?>
                <div class="col">
                    <div class="row mt-2">
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">Data sekolah
                            <strong>gagal diupload</strong> <?= $this->session->flashdata('flash_failed'); ?>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="mb-0">Kelola Sekolah</h3>
                </div>
                                    ...
                                    <!-- <div class="modal  fade bd-example-modal-lg-<?= $row['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content  ml-auto">
                                                <div class="row">
                                                    <div class="col-sm-6"><img src=" <?php if ($row['gambar'] == 'default.png') : ?>
                                                <?php echo base_url('assets/img/sekolah/default.png'); ?>
                                            <?php else : ?>
                                                <?php echo base_url('assets/img/sekolah/gambar/' . $row['gambar']); ?>
                                            <?php endif; ?>" alt="detailgambar"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div> -->
