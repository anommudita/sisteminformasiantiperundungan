        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Edit Lapor Perundungan</h6>
                </div>
                <div class="col-lg-6 col-5 text-right">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            <li class="breadcrumb-item"><a href="<?php echo site_url('guru'); ?>"><i class="fas fa-edit"></i></a></li>
                            <li class="breadcrumb-item"><a href="<?= base_url('guru/lapor_siswa'); ?>">Lapor Perundungan</a></li>
...
<div class="container-fluid mt--6">
    <?= form_open_multipart('guru/edit_lapor_siswa/' . $lapor_siswa['id_laporan']) ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="nisn" value="<?= $lapor_siswa['nisn'] ?>" class="form-control" id="nisn">
                            <small class="text-danger"> <?= form_error('nisn'); ?></small>
                            <small id="notif" name="notif" class="text-danger pl-1"></small>
                        </div>

                        <!-- ID Siswa -->
                        <label hidden class="form-control-label" for="id_siswa">ID SIswa:</label>
                        <input hidden type="number" name="id_siswa" value="<?= $lapor_siswa['id_siswa'] ?>" class="form-control" id="id_siswa">

                        <!-- Nama Siswa -->
                        <div class="form-group">
                            <label class="form-control-label" for="name">Nama siswa:</label>
                            <input readonly type="text" name="name" value="<?= $lapor_siswa['nama_siswa'] ?>" class="form-control" id="name">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="kelas" class="form-control" id="kelas" readonly>
                                        ...
                                        <?php foreach ($kelas as $row) : ?>
                                            <option value="<?= $row['id']; ?>" <?= ($lapor_siswa['kelas_siswa'] === $row['id']) ? 'selected' : ''; ?>><?= strtoupper($row['kelas']); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="sekolah" class="form-control" id="sekolah" readonly>
                                        ...
                                        <?php foreach ($sekolah as $row) : ?>
                                            <option value="<?= $row['id']; ?>" <?= ($lapor_siswa['sekolah'] === $row['id']) ? 'selected' : ''; ?>><?= strtoupper($row['nama_sekolah']); ?></option>
                                        <?php endforeach; ?>
                                    </select>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="keterangan" name="keterangan" rows="16"><?= $lapor_siswa['keterangan'] ?></textarea>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#nisn').on('input', function() {
                ...
                $.ajax({
                    url: '<?= base_url('guru/get_data_nisn'); ?>',
                    method: 'POST',
                    data: {
                        nisn: nisn
                    },
