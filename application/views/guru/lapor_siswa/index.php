        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item active"><a href="<?= base_url('guru/lapor_siswa') ?>">Data Laporan</a></li>
                        </ol>
                    </nav>
                    <!-- Flashdata! -->
                ...
                <div class="col-lg-6 col-5 text-right">
                    <a href="<?= base_url('guru/tambah_lapor_siswa') ?>" class="btn btn-sm btn-neutral">Tambah</a>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <?php foreach ($laporan as $row) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- log -->
                                            <a href="<?= base_url('guru/log/') . $row['id_laporan'] ?>" class="btn btn-primary btn-sm"><i class="fa fa-file-invoice"></i></a>
                                            <!-- edit -->
                                            <a href="<?= base_url('guru/edit_lapor_siswa/' . $row['id_laporan']) ?>" class="btn btn-warning btn-sm btnEdit"><i class=" fa fa-edit"></i></a>
                                            <!-- hapus -->
                                            <a href="<?= base_url('guru/hapus_laporan_siswa/') . $row['id_laporan'] . '/' . $row['id_siswa'] ?>" class="btn btn-danger btn-sm delete-lapor-siswa"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                    </div>
                <?php endforeach; ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <ul class="list-group">
                                                    ...
                                                    <li class="list-group-item"> <b class="text-success">Keterangan : </b> <?= $row['keterangan'] ?></li>
